            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: order.orderType == OrderType.dineIn
                        ? AppColors.statusBlue.withAlpha(60)
                        : AppColors.statusOrange.withAlpha(60),
              ...
              children: [
                if (order.customerName.isNotEmpty)
                  Text(order.customerName,
                    style: const TextStyle(
                      color: AppColors.goldBrown, fontSize: 12,
                ...
                Row(
                  children: [
                    ...
                    if (nextStatus != null)
                      GestureDetector(
                        onTap: () => ref
                            .read(kdsActionsNotifierProvider.notifier)
                            .advance(order.id, nextStatus!),
                        child: Container(
